...
import gradeManagementSystemResult1 from './GradeManagementSystemResult1.png';
import gradeManagementSystemResult2 from './GradeManagementSystemResult2.png';
import simpleBulletinBoard1 from './SimpleBulletinBoardResult1.png';
import simpleBulletinBoard2 from './SimpleBulletinBoardResult2.png';
import simpleBulletinBoard3 from './SimpleBulletinBoardResult3.png';
import quizTableResult from './QuizTableResult.png';
...
export const personalProject = {
  ...
  linkInfo: [
    { index: 'readme', image: github, desc: 'README 소개 보러가기' },
    { index: 'code', image: code, desc: '구현 코드 보러가기' },
    { index: 'blog', image: blog, desc: '구현 과정기록 보러가기' },
  ],
  element: [
    {
      index: 'GradeManagementSystem',
      ...
      contents: {
        ...
        result: [
          {
            title: 'GradeManagementSystemResult1',
            image: gradeManagementSystemResult1,
            width: '80%',
          },
          {
            title: 'GradeManagementSystemResult2',
            image: gradeManagementSystemResult2,
            width: '80%',
          },
        ],
        links: {
    ...
    },
    {
      ...
      contents: {
        ...
        result: [
          {
            title: 'SimpleBulletinBoardResult1',
            image: simpleBulletinBoard1,
            width: '100%',
          },
          {
            title: 'SimpleBulletinBoardResult2',
            image: simpleBulletinBoard2,
            width: '100%',
          },
          {
            title: 'SimpleBulletinBoardResult3',
            image: simpleBulletinBoard3,
            width: '80%',
          },
        ],
        links: {
    ...
    },
    {
      ...
      contents: {
        ...
        result: [
          {
            title: 'QuizTableResult',
            image: quizTableResult,
            width: '100%',
          },
        ],
        links: {
